...
#### `--version <version>`
Set the standard version (default: 1.0.0).

```bash
mcp-standards generate --template technical --version 2.0.0
```
...
4. **Version control**: Commit generated standards to version control
