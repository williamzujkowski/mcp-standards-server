...
async def main():
    ...
    if completed_steps == total_steps:
        print("   ✅ All workflows function correctly")
        print("   📈 Consider testing more complex workflows")
    elif completed_steps >= total_steps * 0.9:
        print("   ⚠️  Minor issues detected in some workflows")
        print("   🔧 Review and fix failing steps")
    else:
        print("   🚨 Significant workflow issues detected")
        print("   🛠️  Immediate attention required for failed workflows")
        print("   📋 Review API endpoint availability and error handling")
