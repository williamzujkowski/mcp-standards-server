...
class CorrectedComplianceMappingTester:
        ...
        for md_file in md_files:
            ...
            if found_controls:
                ...
                self.nist_references_in_files[md_file.name] = {
                    'controls': sorted(list(found_controls)),
    ...
    async def generate_comprehensive_report(self):
        ...
        if total_nist_controls_in_files > 0 and total_mappings_found == 0:
            ...
            print(f"   💡 This suggests a data synchronization or parsing issue")
        ...
        print(f"   • NIST 800-53 framework: Partially supported (parsing issues)")
        print(f"   • Control identification: Working (found in source files)")
        print(f"   • Metadata integration: BROKEN (not accessible via API)")
