...
class HistoricalAnalyzer:
    ...
    def load_history(self, benchmark_name: Optional[str] = None):
    ...
    def _extract_metric(self, result: BenchmarkResult, metric: str) -> Optional[float]:
    ...
    def _generate_forecast_warning(self, slope: float, values: List[float]) -> Optional[str]:
