...
from src.core.cache.decorators import (
    ...
    CacheKeyConfig, generate_cache_key, CacheManager
)
...
class TestCacheResultDecorator:
    ...
    def test_condition_function(self, mock_cache):
        ...
        result1 = conditional_func("test1")
        assert mock_cache.get.called
        
        # With cache disabled
        mock_cache.reset_mock()
        result2 = conditional_func("test2", use_cache=False)
