...
class TestRuleGroup:
    ...
    def test_and_logic(self):
        ...
        assert group.evaluate({"language": "javascript", "framework": "fastapi"}) is False
    ...
    def test_not_logic(self):
        ...
        group = RuleGroup(
            ...
            conditions=[
                RuleCondition("production", RuleOperator.EQUALS, True)
            ]
        )
        ...
        rule = StandardRule(
            ...
            conditions=RuleGroup(
                ...
                conditions=[
                    ...
                    RuleCondition("requirements", RuleOperator.CONTAINS, "accessibility")
                ]
            ),
...
class TestRuleEngine:
    ...
    def test_priority_resolution(self):
        ...
        assert set(result['resolved_standards']) == {
            "api-standard", "common-standard", "specific-standard"
        }
    ...
    def test_tag_filtering(self, sample_rules_file):
        ...
        result = engine.evaluate(
            {"language": "python", "requirements": ["security"]},
            tags=["python"]
        )
...
class TestRuleEngineIntegration:
    ...
    def rules_file_path(self) -> Path:
        ...
        return Path(__file__).parent.parent.parent.parent.parent.parent / "data" / "standards" / "meta" / "standard-selection-rules.json"
