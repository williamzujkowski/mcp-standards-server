...
from src.core.standards.async_semantic_search import (
    AsyncSemanticSearch, AsyncSearchConfig, BatchProcessor, VectorIndexCache, MemoryManager
)
from src.core.cache.redis_client import RedisCache, CacheConfig
from src.core.standards.vector_index_cache import (
    VectorIndexCache as VectorCache, VectorIndexConfig, VectorIndexBuilder
)
from src.core.performance.memory_manager import (
    MemoryManager as MemoryMgr, MemoryConfig, MemoryEfficientDict, MemoryEfficientList
)
from src.core.performance.metrics import (
    PerformanceMonitor, PerformanceConfig, MetricDefinition, MetricType
)
from src.core.database.query_optimizer import (
    DatabaseOptimizer, QueryCacheConfig, QueryCache
)
...
class TestVectorIndexCaching:
    ...
    async def test_index_caching(self, vector_cache):
        ...
        index = await vector_cache.build_and_cache_index("cached_index", vectors)
