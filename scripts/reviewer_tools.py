...
class ReviewerManager:
    ...
    def assign_reviewers(self, standard_name: str, domain: str, pr_number: Optional[int] = None) -> Dict[str, List[str]]:
        """
    ...
    def complete_review(self, standard_name: str, reviewer: str, stage: str, feedback_url: Optional[str] = None):
