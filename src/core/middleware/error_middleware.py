...
class WebSocketErrorHandler:
    ...
    async def handle_error(self, error: Exception, context: dict[str, Any] | None = None):
        ...
        try:
            ...
            self.logger.error(
                ...
                extra={
                    ...
                    'context': context,
                    'traceback': traceback.format_exc() if not isinstance(error, MCPError) else None
                }
            )
            ...
            self.metrics.record_error(
                ...
                error_code=getattr(error, 'code', ErrorCode.SYSTEM_INTERNAL_ERROR).value
            )
