...
def setup_logging(config: Optional[LoggingConfig] = None) -> ErrorTrackingHandler:
    """
...
_error_handler: Optional[ErrorTrackingHandler] = None


def get_error_handler() -> Optional[ErrorTrackingHandler]:
