...
class StandardRule:
    ...
    description: str
    priority: int
    conditions: Union[RuleCondition, RuleGroup]
    standards: List[str]
...
class RuleEngine:
    ...
    def _parse_conditions(self, conditions_data: Union[Dict, List]) -> Union[RuleCondition, RuleGroup]:
    ...
    def _extract_key_fields(self, conditions: Union[RuleCondition, RuleGroup], 
                           fields: Optional[Set[str]] = None) -> Set[str]:
    ...
    def _conditions_to_dict(self, conditions: Union[RuleCondition, RuleGroup]) -> Dict:
