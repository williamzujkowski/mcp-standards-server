...
class MicroStandardsGenerator:
    ...
    def generate_chunks(self, standard: Standard, context: Optional[ChunkingContext] = None) -> List[MicroStandard]:
    ...
    def _find_code_explanation(self, content: str, code: str) -> Optional[str]:
