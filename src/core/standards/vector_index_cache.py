...
class VectorIndexBuilder:
    ...
    def build_index(self, vectors: np.ndarray, index_type: Optional[str] = None) -> faiss.Index:
...
class VectorIndexCache:
    ...
    async def get_index(self, index_id: str) -> Optional[faiss.Index]:
    ...
    async def build_and_cache_index(self, 
                                  index_id: str,
                                  vectors: np.ndarray,
                                  index_type: Optional[str] = None) -> faiss.Index:
