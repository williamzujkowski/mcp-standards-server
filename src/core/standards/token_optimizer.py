...
class TokenOptimizer:
    ...
    def optimize_standard(self,
                         ...
                         context: dict[str, Any] | None = None) -> tuple[str, CompressionResult]:
    ...
    def _format_full(self,
                     ...
                     budget: TokenBudget,
                     required_sections: list[str] | None) -> tuple[str, CompressionResult]:
    ...
    def _format_custom(self,
                      ...
                      context: dict[str, Any] | None) -> tuple[str, CompressionResult]:
    ...
    def auto_select_format(self,
                          standard: dict[str, Any],
                          budget: TokenBudget,
                          context: dict[str, Any] | None = None) -> StandardFormat:
    ...
    def _get_cache_key(self,
                      ...
                      required_sections: list[str] | None) -> str:
...
# Utility functions
def create_token_optimizer(model_type: str | ModelType = ModelType.GPT4,
                          default_budget: int | None = None) -> TokenOptimizer:
