...
class EnhancedNaturalLanguageMapper:
    ...
    def __init__(
        self,
        static_mappings: Optional[List[NaturalLanguageMapping]] = None,
    ...
    def _map_static(self, query: str, confidence_threshold: float) -> Optional[MappingResult]:
    ...
    def _combine_results(
        self,
        static_result: Optional[MappingResult],
        semantic_result: Optional[MappingResult],
        query: str
    ) -> MappingResult:
