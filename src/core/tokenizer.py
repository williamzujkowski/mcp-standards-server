...
def count_tokens(text: str, tokenizer: BaseTokenizer | None = None) -> int:
...
def truncate_to_tokens(text: str, max_tokens: int, tokenizer: BaseTokenizer | None = None) -> str:
...
class TokenBudget:
    ...
    def __init__(self, total_tokens: int, tokenizer: BaseTokenizer | None = None):
