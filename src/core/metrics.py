...
class MetricsCollector:
    ...
    def get_summary(self, name: str, metric_type: MetricType, labels: Optional[Dict[str, str]] = None) -> Optional[MetricSummary]:
    ...
    def get_all_metrics(self) -> Dict[str, Any]:
        ...
        for key, data in list(self._histograms.items()):
        ...
        for key, data in list(self._timers.items()):
