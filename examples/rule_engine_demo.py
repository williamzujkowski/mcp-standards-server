...
def print_results(context: dict, result: dict):
    ...
    if result['conflicts']:
        ...
        for conflict in result['conflicts']:
            print(f"  - Standard '{conflict['standard']}' provided by rules: {', '.join(conflict['rules'])}")
...
def main():
    ...
    rules_path = Path(__file__).parent.parent / "data" / "standards" / "meta" / "standard-selection-rules.json"
